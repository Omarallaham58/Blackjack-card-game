wlcm="Welcome to blackbox game, we wish you a good luck !!!"
remark="Remark that here the ace plays a role similar to the joker, it can convert it's value from 11 to 1 if needed to avoid the loss of the player."
logo=""" _____
     |\ ~ /|
     |}}:{{|
     |}}:{{|  _____
